...
export default function VaultPage() {
    ...
    const handleDeposit = async () => {
        ...
        try {
            ...
            // Refresh vault activity from Etherscan
            setTimeout(() => {
                refetchActivities();
            }, 2000);
            ...
            <div className="max-w-6xl mx-auto">
                                ...
                                <div className="bg-slate-700/30 rounded-lg p-4 hover:bg-slate-700/50 transition-colors">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            ...
                                            <p className="text-slate-400 text-xs">35% allocation</p>
                                        </div>
                                    ...
                                    <p className="text-slate-400 text-xs mt-2">$3,500.00 deployed • 8.2% APY</p>
                                </div>
                                ...
                                <div className="bg-slate-700/30 rounded-lg p-4 hover:bg-slate-700/50 transition-colors">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            ...
                                            <p className="text-slate-400 text-xs">45% allocation</p>
                                        </div>
                                        <span className="bg-green-500/20 text-green-300 text-xs px-2 py-1 rounded">
                                            +$1,890.75
                                        </span>
                                    ...
                                    <p className="text-slate-400 text-xs mt-2">$4,500.00 deployed • 7.5% APY</p>
                                </div>
                                ...
                                <div className="bg-slate-700/30 rounded-lg p-4 hover:bg-slate-700/50 transition-colors">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            ...
                                            <p className="text-slate-400 text-xs">20% allocation</p>
                                        </div>
                                        <span className="bg-green-500/20 text-green-300 text-xs px-2 py-1 rounded">
                                            +$768.25
                                        </span>
                                    ...
                                    <p className="text-slate-400 text-xs mt-2">$2,000.00 deployed • 6.8% APY</p>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div className="mt-8 bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-lg font-bold text-white">Vault Activity</h3>
                        <button
                            onClick={refetchActivities}
                            disabled={activitiesLoading}
                            className="p-2 hover:bg-slate-700/50 rounded-lg transition-colors disabled:opacity-50"
                        >
                            <Loader2 className={`w-4 h-4 text-slate-400 ${activitiesLoading ? "animate-spin" : ""}`} />
                        </button>
                    </div>
                    ...
                    {activitiesLoading && activities.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {activities.map((tx: any, index: number) => (
                                <div
                                    key={index}
                                ...
                                >
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            <a
                                                href={`https://sepolia.etherscan.io/tx/${tx.hash || tx.txHash}`}
                                                target="_blank"
                                                rel="noopener noreferrer"
