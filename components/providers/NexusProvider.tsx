"use client";
import useInitNexus from "@/lib/hooks/useInitNexus";
...
const NexusProvider = ({children}: {children: React.ReactNode}) => {
    ...
    const {nexusSDK, initializeNexus, deinitializeNexus, attachEventHooks, intentRefCallback, allowanceRefCallback} =
        useInitNexus(sdk);
